...
#
#
class CostFunL2ImagesLucasKanade(CostFunL2Images):
    ...
    def __init__(self, object_model, motion_model, show_debug_info=False):
        ...
        :return:
        """
        super(CostFunL2ImagesLucasKanade, self).__init__(object_model, motion_model, show_debug_info)
    ...
    def computeJacobian(self, motion_params):
        ...
        # Compute the Jacobian matrix at the current params
        self.__J = self.__computeJacobianMatrix(motion_params)
        #
        return self.__J
    ...
    def computeJacobianPseudoInverse(self, motion_params):
        ...
        #
        self.__J = self.__computeJacobianMatrix(motion_params)
        # Inverse of the current Jacobina
        self.__invJ = self.__computeInverseJacobianMatrix()
        #
    ...
    def updateMotionParams(self, motion_params, delta_params):
        ...
        return delta_params + motion_params

    ##
    #
    #
    def __computeInverseJacobianMatrix(self):
        #
    ...
    #
    #
    def __computeJacobianMatrix(self, motion_params):
        #
        template_coords = self.object_model.getReferenceCoords()
        ...
        Jf = self.motion_model.computeJacobian(template_coords, motion_params)
        #
